                                        ...
                                        <div className="dealer-author-content">
                                            <div className="dealer-author-item">
                                                ...
                                                <div className="dealer-content-info-box">
                                                    ...
                                                    <Link className="dealer-title" href="/mailto:contact@MILLCARS.com">
                                                        contact@millcars.com </Link>
                                                </div>
                                            </div>
                                            <div className="dealer-author-item">
                                                <div className="dealer-author-icon">
                                            ...
                                            <div className="dealer-author-item">
                                                ...
                                                <div className="dealer-content-info-box">
                                                    ...
                                                    <Link className="dealer-title" href="/#" target="_blank">www.MILLCARS.com </Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

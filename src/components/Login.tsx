            ...
            <div className="rounded-3xl border border-outline-variant/10 bg-surface-container-lowest p-8 shadow-sm sm:p-10">
              ...
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-3 rounded-2xl border border-outline-variant bg-surface px-4 py-3 transition-all hover:bg-surface-container hover:shadow-md active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed"
                >
                ...
                <form className="space-y-4" onSubmit={handleLogin}>
                  ...
                  <button
                    className="mt-2 w-full rounded-2xl bg-primary px-4 py-3.5 font-bold text-on-primary transition-transform hover:scale-[1.01] active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed"
                    type="submit"
                    disabled={isSubmitting}
                  >
                    {isSubmitting ? 'Verificando…' : 'Continuar acceso'}
                  </button>
                </form>
              </div>
